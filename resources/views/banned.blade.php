...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-9 col-lg-9">
            <h3 class="page-title"><span aria-hidden="true" class="li_lock"></span> {{ __('Action required') }}</h3>
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <i>Note: your character is left untouched, and if it's alive other players can still interact with it as usual.</i>
                </div>
        </div>
    </div>
</div>
