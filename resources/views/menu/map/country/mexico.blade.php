<figure id="mapsvg">
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 490 420" preserveAspectRatio="xMinYMin meet" >
        <image width="490" height="420" xlink:href="/mexico.png" />
        @for ($i = 0; $i < 7; $i++)
            @for ($j = 0; $j < 6; $j++)
                @php
                ...
                <g opacity="{{ isset($currentTile) ? '1' : '0' }}">
                    <a {{ isTileForSale('mexico', $i + $j * 7) ? 'xlink:href=/map/'.($i + $j * 7) : '' }}>
